...
const startCoffees = [
    ...
    { name: 'Espresso con Panna', description: 'espresso with cream', size: 'small', price: '$1.00' },
    { name: 'Caramel Machiatto', description: 'vanilla syrup, steamed milk, espresso, caramel sauce', size: 'small', price: '$1.50' },
    { name: 'Caffe Americano', description: 'hot water and espresso', size: 'small', price: '$1.00' },
